...
(function($) {
   ...
   /* ajaxchimp
	...
	/* Map
	------------------------------------------------------ */
	var latitude = 38.92711525530861,
		 longitude = 1.4247613560211656,
		 map_zoom = 15,		 
		 main_color = '#d8ac00',
		 saturation_value= -30,
		 brightness_value= 5,
   ...
   // marker url
	if ( winWidth > 480 ) {
		marker_url = '/assets/icon-location-b-4be54ad4a98cf0c701bd0a942f25524389b1241a6561c974bc99e75c663d64b1.png';
   } else {
      marker_url = '/assets/icon-location-77a233bb7fda3a039233b75447f24ca0fa4a0e3ce1194a83dbc8e59d7be9598b.png';
   }	 
